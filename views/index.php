...
<?php $this->load->view('jquery_astreintes'); ?>
...
<div class="grid_7" id="content_wrapper">
	...
	<div class="section_wrapper">
		...
		<h3 class="title_black"><?php echo $this->lang->line('astreintes'); ?>
...
<?php $this->load->view('dashboard/sidebar', array('side_block'=>'astreintes/sidebar')); ?>
